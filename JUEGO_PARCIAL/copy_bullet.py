...
class Bullet:
    def __init__(self, x=0, y=0):
        self.bullet = Auxiliar.getSurfaceFromSpriteSheet(r"resources\Bullet\fire.png", 11, 1, True, 1, 2)
        self.frame = 0
        ...
        self.bullet_rect.x, self.bullet_rect.y, self.bullet_rect.width, self.bullet_rect.height
        )  # Corregido para usar dimensiones reales
